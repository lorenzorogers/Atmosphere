...
public record RawWeatherData(double latitude, double longitude, long generationtime_ms, float utc_offset_seconds, String timezone, String timezone_abbreviation, int elevation, RawHourlyUnits hourly_units, RawHourlyData hourly) {
